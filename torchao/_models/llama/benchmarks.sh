...
export MODEL_REPO=meta-llama/Meta-Llama-3-8B
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --write_result benchmark_results.txt --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization int4wo-64  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --precision float16 --quantization gemlite-4-64  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization gemlite-4-64  --write_result benchmark_results.txt  --compile --num_samples 1

python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --batch_size 2 --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization int4wo-64 --batch_size 2  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --precision float16 --quantization gemlite-4-64 --batch_size 2  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization gemlite-4-64 --batch_size 2  --write_result benchmark_results.txt  --compile --num_samples 1

python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --batch_size 4 --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization int4wo-64 --batch_size 4  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --precision float16 --quantization gemlite-4-64 --batch_size 4  --write_result benchmark_results.txt  --compile --num_samples 1
python generate.py --checkpoint_path $CHECKPOINT_PATH/$MODEL_REPO/model.pth --quantization gemlite-4-64 --batch_size 4  --write_result benchmark_results.txt  --compile --num_samples 1
